...
ratings$eBMRQ_total <- apply(bmrq,1, sum) # total BMRQ scores --> Need to add absorption scores
...
PASS[] <- lapply(PASS, gsub, pattern = "TRUE", replacement = 0, fixed = TRUE) 
PASS[] <- lapply(PASS, gsub, pattern = "FALSE", replacement = 1, fixed = TRUE)
