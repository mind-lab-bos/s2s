...
m1c <- lmer(data=speech_master, scale(value) ~ Q409*pre_post*stim_type + (Q409|ResponseId), control=lmerControl(optimizer="bobyqa"))
summary(m1c)

m2c <- lmer(data=liking_master, scale(value) ~ Q409*pre_post*stim_type + (1|ResponseId), control=lmerControl(optimizer="bobyqa"))
summary(m2c)
